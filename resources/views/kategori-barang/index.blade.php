<x-layout.app title="Kategori Barang" activeMenu="kategori-barang" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="Kategori Barang" :breadcrumbs="[
                ...
                <div class="row g-3 justify-content-between align-items-center">
                    @can('kategori-barang create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('kategori-barang.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input 
                                ...
                                hx-get="{{ route('kategori-barang.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms"
                                hx-target="#kategori-barang-table"
                                hx-push-url="true"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari kategori barang...</span>
                    </div>
                </div>

                <div id="kategori-barang-table">
                    @include('kategori-barang.includes.index-table', compact('kategoriBarang'))
                </div>
            </div>
        </div>
    </div>
