<x-layout.app title="Master Lokasi" activeMenu="master-lokasi" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="Master Lokasi" :breadcrumbs="[
        ...
        <div class="card">
            <div class="card-header">
                <div class="row g-3 justify-content-between align-items-center">
                    @can('master-lokasi create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('master-lokasi.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input 
                                ...
                                name="search" 
                                class="form-control"
                                placeholder="Cari master lokasi..."
                                value="{{ old('search', request('search')) }}"
                                hx-get="{{ route('master-lokasi.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms"
                                hx-target="#master-lokasi-table"
                                hx-push-url="true"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari master lokasi...</span>
                    </div>
                </div>

                <div id="master-lokasi-table">
                    @include('master-lokasi.includes.index-table', compact('masterLokasi'))
                </div>
            </div>
        </div>
    </div>
