<x-layout.app title="Master Status Kondisi" activeMenu="master-status" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="Master Status" :breadcrumbs="[
            ...
            <div class="card-header">
                <div class="row g-3 justify-content-between align-items-center">
                    ...
                    <div class="col-12 col-md-auto">
                        <a href="{{ route('master-status.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control" placeholder="Cari master status..."
                                value="{{ old('search', request('search')) }}"
                                hx-get="{{ route('master-status.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms"
                                hx-target="#master-status-table" hx-push-url="true" hx-indicator="#search-loading"
                                ...
                                <li>
                                    <div class="mx-2 form-check">
                                        <x-input.checkbox class="form-check-input" id="checkbox-all"
                                            :checked="count($columns) == count($selectedColumns)" :parent="true" />
                                ...
                                <li>
                                    <div class="mx-2 form-check">
                                        <x-input.checkbox class="form-check-input" id="checkbox-{{ $column }}"
                                            ...
                                            :checked="in_array($column, $selectedColumns)" parentId="checkbox-all" />
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari master status...</span>
                    </div>
                </div>

                <div id="master-status-table">
                    @include('master-status.includes.index-table', compact('masterStatus'))
                </div>
            </div>
        </div>
    </div>
