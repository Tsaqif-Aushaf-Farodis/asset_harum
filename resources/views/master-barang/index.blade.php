<x-layout.app title="Master Barang" activeMenu="master-barang" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="Master Barang" :breadcrumbs="[
                ...
                <div class="row g-3 justify-content-between align-items-center">
                    @can('master-barang create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('master-barang.create') }}" class="btn btn-primary w-100 w-md-fit">
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari master barang...</span>
                    </div>
                </div>

                <div id="master-barang-table">
                    @include('master-barang.includes.index-table', compact('masterBarang'))
                </div>
            </div>
        </div>
    </div>
