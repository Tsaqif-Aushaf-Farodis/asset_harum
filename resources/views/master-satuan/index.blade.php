<x-layout.app title="Master Satuan" activeMenu="master-satuan" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="Master Satuan" :breadcrumbs="[
        ...
        <div class="card">
            <div class="card-header">
                <div class="row g-3 justify-content-between align-items-center">
                    @can('master-satuan create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('master-satuan.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input 
                                ...
                                name="search" 
                                class="form-control"
                                placeholder="Cari master satuan..."
                                value="{{ old('search', request('search')) }}"
                                hx-get="{{ route('master-satuan.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms"
                                hx-target="#master-satuan-table"
                                hx-push-url="true"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari master satuan...</span>
                    </div>
                </div>

                <div id="master-satuan-table">
                    @include('master-satuan.includes.index-table', compact('masterSatuan'))
                </div>
            </div>
        </div>
    </div>
