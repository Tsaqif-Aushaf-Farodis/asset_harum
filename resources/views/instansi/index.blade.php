<x-layout.app title="Instansi" activeMenu="instansi" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="Instansi" :breadcrumbs="[
                ...
                <div class="row g-3 justify-content-between align-items-center">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control" placeholder="Cari instansi..."
                                value="{{ old('search', request('search')) }}" hx-get="{{ route('instansi.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms" hx-target="#instansi-table"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari instansi...</span>
                    </div>
                </div>

                <div id="instansi-table">
                    @include('instansi.includes.index-table', compact('instansi'))
                </div>
            </div>
        </div>
    </div>
