<x-layout.app title="Master Sub Lokasi" activeMenu="master-sub-lokasi" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="Master Sub Lokasi" :breadcrumbs="[
            ['label' => 'Dashboard', 'url' => url('/')],
            ['label' => 'Master Sub Lokasi'],
        ]" />
        
        <div class="card">
            <div class="card-header">
                <div class="row g-3 justify-content-between align-items-center">
                    @can('master-sub-lokasi create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('master-sub-lokasi.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input 
                                ...
                                name="search" 
                                class="form-control"
                                placeholder="Cari master sub lokasi..."
                                value="{{ old('search', request('search')) }}"
                                hx-get="{{ route('master-sub-lokasi.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms"
                                hx-target="#master-sub-lokasi-table"
                                hx-push-url="true"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari master sub lokasi...</span>
                    </div>
                </div>

                <div id="master-sub-lokasi-table">
                    @include('master-sub-lokasi.includes.index-table', compact('masterSubLokasi'))
                </div>
            </div>
        </div>
    </div>
